...
/* harmony import */ var _mobile_menu_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./mobile-menu.js */ "./src/js/mobile-menu.js");
/* harmony import */ var _header_scroll_js__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./header-scroll.js */ "./src/js/header-scroll.js");
/* harmony import */ var _paginator_js__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./paginator.js */ "./src/js/paginator.js");
/* harmony import */ var _courses_slider_js__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./courses-slider.js */ "./src/js/courses-slider.js");
/* harmony import */ var _slider_js__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./slider.js */ "./src/js/slider.js");
/* harmony import */ var _data_for_sliders_js__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./data-for-sliders.js */ "./src/js/data-for-sliders.js");
/* harmony import */ var _form__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./form */ "./src/js/form.js");
/* harmony import */ var _scroll_js__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./scroll.js */ "./src/js/scroll.js");
/* harmony import */ var _select__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./select */ "./src/js/select.js");
/* harmony import */ var _customers_paginator_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./customers-paginator.js */ "./src/js/customers-paginator.js");
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    key: "getSliderData",
    value: function () {
      var _getSliderData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var num,
          response,
          _args = arguments;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                num = _args.length > 0 && _args[0] !== undefined ? _args[0] : 1;
                _context.next = 3;
                return fetch("https://jsonplaceholder.typicode.com/albums/".concat(num, "/photos"));
              case 3:
      ...
      function getSliderData() {
        return _getSliderData.apply(this, arguments);
      }
    ...
    key: "updateSlider",
    value: function () {
      var _updateSlider = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(id) {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.t0 = this.slider;
                _context2.next = 3;
                return this.getSliderData(id);
              case 3:
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 10:
                ...
                (0,_customers_paginator_js__WEBPACK_IMPORTED_MODULE_31__.customersPaginator)(_data_for_sliders_js__WEBPACK_IMPORTED_MODULE_27__.dataForCustomersSlider);
              case 14:
              case "end":
...
function slideTemplate(elem) {
  var width = checkStars(elem.countOfStars);
  var id = elem.id,
    personImg = elem.personImg,
    backUrl = elem.backUrl,
...
var dotsWrapper = document.querySelector(".customer__dots");
var active = "customer__dot_active";
var img = document.querySelector(".customer__img");
var square = document.querySelector(".customer__square");
var icon = document.querySelector(".customer__icon_elem");
function customersPaginator(data) {
  createDot(data);
  clickHandler(data);
}
function clickHandler(data) {
  var dots = document.querySelectorAll(".customer__dot");
...
function setData(data, number) {
  var textField = document.querySelector(".customer__text"),
    nameField = document.querySelector(".customer__name");
  var _data$number = data[number],
    imgUrl = _data$number.imgUrl,
    color = _data$number.color,
    text = _data$number.text,
    author = _data$number.author;
  textField.innerHTML = text;
  nameField.innerHTML = author;
  img.style.cssText = "\n  background: url(\"".concat(imgUrl, "\") center center/ cover no-repeat;\n  ");
...
function submitHendler() {
  form.addEventListener("submit", function (e) {
    ...
    inputs.forEach(function (input, i) {
      if (input.value == "") {
        document.querySelector("label[for=\"".concat(input.getAttribute("id"), "\"]")).innerText = "You must fill in the field";
...
function formValidate(input) {
  ...
  if (id == "fullname") {
    ...
    var _reg = new RegExp(/^[\d\+][\d\(\)\ -]{4,14}\d$/);
    if (input.value == "") {
      return "";
    } else if (!_reg.test(input.value)) {
      return "You must enter +380000000000";
    } else {
      return "";
    }
  } else if (id == "email") {
    var _reg2 = new RegExp(/^([a-z0-9_-]+\.)*[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)*\.[a-z]{2,6}$/);
    if (input.value == "") {
      return "";
    } else if (!_reg2.test(input.value)) {
...
function changeHendler() {
  form.addEventListener("keyup", function (e) {
    ...
    if (target.classList.contains("form__input")) {
      var text = formValidate(target);
      document.querySelector("label[for=\"".concat(target.getAttribute("id"), "\"]")).innerText = text;
      illuminationForInput(text, target);
      var d = JSON.parse(localStorage.getItem("formData"));
      if (d) {
  ...
  if (data && localStorage.getItem("formData") != null) {
    inputs.forEach(function (input) {
      if (data[input.getAttribute("name")]) {
        ...
        var text = formValidate(input);
        document.querySelector("label[for=\"".concat(input.getAttribute("id"), "\"]")).innerText = text;
...
/* harmony export */ });
var humburgerElem = document.querySelector(".header__humburger"),
...
/* harmony import */ var core_js_modules_es_math_trunc_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.math.trunc.js */ "./node_modules/core-js/modules/es.math.trunc.js");
...
var buttonsParent = document.querySelector(".blog__list"),
...
function templateBlogElements(id, title, url, userImage, redirectLink, category) {
  return "\n              <div id=\"".concat(id, "\" class=\"blog__wrap-item flex_justify-c\">\n                <div class=\"blog__wrap-left\">\n                  <div class=\"blog__name\">").concat(category, "</div>\n                  <img\n                    src=\"").concat(userImage, "\"\n                    alt=\"person\"\n                    class=\"blog__person-img\"\n                    width=\"48\"\n                  />\n                </div>\n                <div class=\"blog__wrap-right\">\n                  <img\n                    src=\"").concat(url, "\"\n                    alt=\"laptops\"\n                    class=\"blog__img\"\n                    width=\"328\"\n                  />\n                  <div class=\"blog__text\">\n                   ").concat(title, "\n                  </div>\n                  <a href=\"").concat(redirectLink, "\" class=\"blog__more\">Read Now</a>\n                </div>\n              </div>\n        ");
}
function templateButtons(num) {
  var hidden = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
  return "\n      <li class=\"blog__elem \">\n                <button class=\"blog__btn ".concat(hidden, "\">").concat(num, "</button>\n              </li>\n    ");
}
...
function clickHandler(data) {
  var btns = document.querySelectorAll(".blog__btn"),
    arrs = _toConsumableArray(btns);
  buttonsParent.addEventListener("click", function (e) {
    var target = e.target;
    arrs.forEach(function (elem, i) {
...
function autoScrollListOfButtons(index, data, btns) {
  var _setTransformValue = setTransformValue(horizontal),
    value = _setTransformValue.value,
    number = _setTransformValue.number;
  if (index <= 3) {
    buttonsParent.setAttribute("style", "transform: ".concat(value, "(-0px)"));
  }
  if (index > 3 && index < btns.length - 1) {
    buttonsParent.setAttribute("style", "transform: ".concat(value, "(-").concat(number * (index - 3), "px)"));
  }
}
function createElements(data, numberOfBtn, coutOfSlides) {
  var halfData = data.slice(numberOfBtn * coutOfSlides - coutOfSlides, numberOfBtn * coutOfSlides);
  halfData.forEach(function (el, index) {
    var id = el.id,
      title = el.title,
      url = el.url,
...
function createButtons(data) {
  ...
  if (dataLength % slides == 0) {
    for (var i = 0; i < dataLength / slides; i++) {
      counter += 1;
      if (counter > 5) {
    ...
    for (var _i = 0; _i < Math.ceil(dataLength / slides); _i++) {
      counter += 1;
      if (counter > 5) {
        buttonsParent.innerHTML += templateButtons(_i + 1, "hidden");
      } else {
        buttonsParent.innerHTML += templateButtons(_i + 1);
      }
    }
  }
...
function smoothScroll() {
  document.querySelectorAll('a[href^="#"').forEach(function (link) {
    link.addEventListener("click", function (e) {
      ...
      var topOffset = document.querySelector(".header").offsetHeight / 2;
...
var Select = /*#__PURE__*/function () {
  ...
  _createClass(Select, [{
    ...
    key: "select",
    get: function get() {
      return _classPrivateFieldGet(this, _select);
    }
  }, {
    ...
    value: function addListItem() {
      var number = 0;
      for (var i = 0; i < this.quantitiOfAlbumId; i++) {
...
var PreferSlider = /*#__PURE__*/function () {
  ...
  _createClass(PreferSlider, [{
    ...
    key: "templateButtons",
    value: function templateButtons(side) {
      return " <svg class=\"slider-btn__img slider-btn__img-".concat(side, "\">\n                  <use href=\"img/sprite.svg#icon-").concat(side, "\" width=\"10\"></use>\n                </svg>");
    }
  }, {
    ...
    key: "slideTemplate",
    value: function slideTemplate(_ref) {
    ...
    key: "assignTranslate",
    value: function assignTranslate() {
      this.box.style.cssText = "transform: translateX(".concat(this.translate, "px)");
    }
  }, {
    key: "nextSlide",
...
window.addEventListener("DOMContentLoaded", function () {
  new _app_js__WEBPACK_IMPORTED_MODULE_0__.App().init();
});
})();
